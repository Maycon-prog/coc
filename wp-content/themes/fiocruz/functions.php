...
function theme_add_scripts()
{
    ...
    wp_enqueue_script('splide-js', get_template_directory_uri() . '/js/splide-4.1.3/dist/js/splide.min.js');
    ...
    wp_enqueue_script('script-js', get_template_directory_uri() . '/js/scripts.js');
}

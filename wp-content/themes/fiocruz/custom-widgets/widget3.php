...
class My_Widget_3 extends Widget_Base {
	...
	protected function render() {
        ...
        echo "<div><iframe width='745' height='419' style='padding: 0;' src='". $settings['Link']['url'] ."' title='YouTube video player' frameborder='0' alt='$settings[texto]' allow='accelerometer; autoplay; clipboard-write;' allowfullscreen></iframe></div>";
	}

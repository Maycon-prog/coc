...
class widget_relacionado3 extends Widget_Base
{

    public function get_name()
    {
        return 'relacionado3'; // nome para usar no código
    }

    public function get_title()
    {
        return 'Relacionado 3'; // nome para o usuario
    }
    ...
    {
        if (isset(get_field("post_relacionado3")->ID)) {

            $post_id = get_field("post_relacionado3")->ID;

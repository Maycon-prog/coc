...
class widget_relacionado4 extends Widget_Base
{

    public function get_name()
    {
        return 'relacionado4'; // nome para usar no código
    }

    public function get_title()
    {
        return 'Relacionado 4'; // nome para o usuario
    }
    ...
    {
        if (isset(get_field("post_relacionado4")->ID)) {

            $post_id = get_field("post_relacionado4")->ID;

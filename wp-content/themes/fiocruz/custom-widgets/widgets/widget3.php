...
class My_Widget_3 extends Widget_Base {
	...
	protected function render() {
        ...
        echo "<div class='ratio ratio-16x9'><iframe src='". $settings['Link']['url'] ."' title='YouTube video player' alt='$settings[texto]' allow='accelerometer; autoplay; clipboard-write;' allowfullscreen></iframe></div>";
	}

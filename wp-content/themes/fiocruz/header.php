        ...
        <header>
            <div id="menu-desktop" class="container">
                ...
                <div class="menu-header">
                    ...
                    <h2 class="legenda-header">Programa de Pós-Graduação em Divulgação da Ciência, Tecnologia e Saúde</h1>
                </div>
            </div>
            <nav class="nav-menu">
                <div class="container">
            ...
            <div id="menu-mobile">
                ...
                <h2 class="legenda-mobile">Programa de Pós-Graduação em Divulgação da Ciência, Tecnologia e Saúde</h1>
